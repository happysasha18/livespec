# live-spec — Product Spec (v1.10.1, 2026-07-15)
...
| INV-147 | The stranger-wish monitor runs as one scheduled instance per host, surfacing items into committed inbox files; the verdict stays the inbox sweep's call [T-20], and an incomplete deposit is retried [INV-67]. | Package repo |
