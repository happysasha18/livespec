# live-spec — Product Spec (v0.16.22, 2026-07-10)
...
A missing personal profile is the card's empty state: package defaults shown, the absence said plainly, the founding offer named. A malformed catalog row is the error state: the render fails loudly. Loading states do not apply to a static page.
