...
| 17 | Internal codes leaked into chat ("INV-8 рекомендует…") — communicator must make translate-before-speaking a hard gate, codes are machine handles only (Alexander 2026-07-04) | S | **landed 2026-07-04** | communicator rule 6 hardened: spec handles (INV-x/E-x/A-x/T-x/row-N/⟨DECIDE⟩) named explicitly as never-spoken machine anchors, with the INV-8 leak as the ❌ example; installed copy synced |
