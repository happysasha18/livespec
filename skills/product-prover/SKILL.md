...
For every operation, transition, rule, or assumption, mentally stress-test it against the families of questions below. Specific cases are yours to invent based on what the operation actually does. These are habits of attention. They are not a checklist.
