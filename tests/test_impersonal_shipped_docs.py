...
class TestImpersonalShippedDocs(unittest.TestCase):
    ...
    def test_spec_anchor_and_index(self):
        with open(os.path.join(ROOT, "PRODUCT_SPEC.md"), encoding="utf-8") as f:
            for line in f:
                if line.startswith("| INV-118 |") and "INV-118" in line and "impersonal" in line.lower():
                    return
        self.fail("INV-118 index row missing or does not carry both INV-118 and impersonal")
