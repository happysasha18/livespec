...
2. *if* the panel holds no widget, *then* the system *shall* show a labelled empty-state message naming the panel. [INV-2]
...
2. *if* the panel holds no widget, *then* the system *shall* show a placeholder. [INV-5]
