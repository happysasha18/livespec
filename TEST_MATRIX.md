...
| M-156 | The stretch's end is unmissable: one short final line LAST (what closed · what's next · what's needed · when the agent wakes), the long report above it, a page deliverable repeating its passport; delivery, not existence; never a stretch ending in a wall above tool noise, never a silent sleep | INV-57 | string | `test_stretch_end_unmissable` | BUILT |
