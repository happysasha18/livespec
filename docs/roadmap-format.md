...
- the generated-section gating, so a section a script builds is output only and a gate reds — turns the suite red on — a hand edit of it, where the roadmap carries such a section;
