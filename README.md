...
|---|---|
| `live-spec-base` | The rulebook above: thirty-three shared rules and the settings ladder. Loaded whenever another pack skill runs; when two skills seem to disagree, this one wins. |
