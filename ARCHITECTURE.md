# live-spec — Architecture (v0.2.2, 2026-07-09)
...
(guardrails, host-contract, package-docs) implement guarantees, not user features, and sit outside this
layer by the project type's own definition.
