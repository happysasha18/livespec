...
| communicator | the human-facing exchange: reports, batched questions, decision pages, done-claim answers, the capture echo + departures board | T-7 (the report step; the walk before it is build-pipeline's), E-22, INV-25, INV-27 | `skills/communicator/SKILL.md:33` (the rules), `:102` (rule 10 — the decision page), `:122` (rule 11 — the evidence walk) |
